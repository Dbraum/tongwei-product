package com.deepexi.productCenter.aop;

import com.alibaba.fastjson.JSON;
import com.deepexi.productCenter.extension.AppRuntimeEnv;
...
public class LogAspect {
    ...
    @Pointcut("execution (* com.deepexi.productCenter.controller..*.*(..))")
    public void controllerLogAop() {
    }

    @Pointcut("execution (* com.deepexi.productCenter.service..*.*(..))")
